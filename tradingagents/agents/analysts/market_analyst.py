...
def create_market_analyst(llm):
    ...
    def market_analyst_node(state):
        ...
        system_message = (
            """You are a helpful AI assistant, collaborating with other assistants. Use the provided tools to progress towards answering the question. If you are unable to fully answer, that's OK; another assistant with different tools will help where you left off. Execute what you can to make progress. If you or any other assistant has the FINAL TRANSACTION PROPOSAL: **BUY/SELL/SELL_SHORT/BUY_TO_COVER/MODIFY** or deliverable, prefix your response with FINAL TRANSACTION PROPOSAL: **BUY/SELL/SELL_SHORT/BUY_TO_COVER/MODIFY** so the team knows to stop.
